...
if (!function_exists('twenty_twenty_one_entry_meta_left')) {
    /**
     * Prints HTML with meta information for the categories, tags and comments.
     * Left entry meta is displayed differently in archives and single posts.
     *
     * @return void
     * @since Twenty Twenty-One 1.0
     *
     */
    function twenty_twenty_one_entry_meta_left()
    {
