            ...
            <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col" colspan="2"><?php esc_html_e('Product', 'woocommerce'); ?></th>
                                ...
                                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                                    ...
                                    <td data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
                                        <div class="media">
                                            <div class="d-flex">
                                                <?php
                                                $thumbnail = apply_filters('woocommerce_cart_item_thumbnail', $_product->get_image(array(150)), $cart_item, $cart_item_key);
                        ...
                        <tr class="bottom_button">
                            ...
                            <td colspan="3">
                                <?php if (wc_coupons_enabled()) { ?>
                                    <div class="cupon_text d-flex align-content-end">
                                        <input type="text" name="coupon_code" id="coupon_code"
                                               value=""
                                               placeholder="<?php esc_attr_e('Coupon code', 'woocommerce'); ?>"/>
                                        <button type="submit" class="primary-btn" name="apply_coupon"
