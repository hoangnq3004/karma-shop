...
if ($max_value && $min_value === $max_value) {
    ...
    $label = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'woocommerce'), wp_strip_all_tags($args['product_name'])) : (!$args['product_name'] ? '' : esc_html__('Quantity', 'woocommerce'));
    ?>
    <div class="quantity">
